 ...
 $log = array();
	...
	while ($row = $mysqli->fetch_assoc($result)) {
		...
		if($row['membership_type'] == 'Single' || $row['membership_type'] == 'Family' && $row['family_head'] == '1'){
			...
			$subject = 'Welcome to Swim Gym Academy! Membership Expiring soon | '.$member_id.'';
				 
						$body = '<p>Hello ' . $name . ',</p>';

						$body .= '<p>We hope you have enjoyed being a member of Swim Gym Academy. We would like to inform you that your membership will expire in 3 days, on ' . $end_date . '.</p>';

						$body .= '<p>To continue your swimming journey with us, please renew your membership. You can visit our reception desk, and our staff will be happy to assist you in selecting a new membership plan that suits your needs.</p>';
